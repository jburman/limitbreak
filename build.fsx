...
let project = "limitbreak"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Functions for tracking event frequency and applying rate limits."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Functions for tracking event frequency and applying rate limits."

// List of author names (for NuGet package)
let author = "Jeremy Burman"

// Tags for your project (for NuGet package)
let tags = "event rate ratelimit"

// File system information
let solutionFile  = "limitbreak.sln"
...
let gitOwner = "jburman"
let gitHome = sprintf "%s/%s" "https://github.com/jburman/limitbreak" gitOwner

// The name of the project on GitHub
let gitName = "limitbreak"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/jburman/limitbreak/jburman"

let website = "/limitbreak"
...
let info =
  [ "project-name", "limitbreak"
    "project-author", "Jeremy Burman"
    "project-summary", "Functions for tracking event frequency and applying rate limits."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/limitbreak" ]
